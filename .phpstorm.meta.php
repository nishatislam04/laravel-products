...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/nishat/laravel-products/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/nishat/laravel-products/public/storage','inertia.ssr.enabled','inertia.ssr.url',
...
'web','api',);
        registerArgumentsSet('routes', 'home.page','signin.page','signup.page','signin',
'signup','signout','contact.page','about.page','vendor.apply.page',
'vendor.apply.store','super-admin.overview.page','super-admin.vendors.page','super-admin.users.page','super-admin.orders.page',
'super-admin.categories.page','super-admin.products.page','super-admin.marketing.page','super-admin.analytics.page','super-admin.settings.page',
'super-admin.approve-vendor','super-admin.reject-vendor','wishlist.page','cart.page','billing.page',
'product-show.page','settings.page','profile.page','addresses.page','payment-options.page',
'orders.page','returns.page','wishlists.page','privacy.page','notifications.page',
'cancellations.page','help-center.page','vendor-admin.overview.page','vendor-admin.staffs.page','vendor-admin.products.page',
'vendor-admin.orders.page','vendor-admin.refunds.page','vendor-admin.analytics.page','vendor-admin.reviews.page','vendor-admin.settings.page',
'vendor-admin.products.store','storage.local',);
