...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/public/storage','ide-helper.filename','ide-helper.models_filename',
...
'session.http_only','session.same_site','session.partitioned','resend.api_key','resend.domain',
'resend.path','resend.webhook.secret','resend.webhook.tolerance','tinker.commands','tinker.alias',
'tinker.dont_alias',);
        registerArgumentsSet('middleware', 
'web','api',);
        registerArgumentsSet('routes', 
'resend.webhook','home.page','signin.page','signup.page',
'signin','signup','signout','contact.page','about.page',
'vendor.apply.page','vendor.apply.store','vendor.apply.otp.page','vendor.apply.otp.store','super-admin.overview.page',
'super-admin.vendors.page','super-admin.users.page','super-admin.orders.page','super-admin.categories.page','super-admin.products.page',
'super-admin.marketing.page','super-admin.analytics.page','super-admin.settings.page','super-admin.approve-vendor','super-admin.reject-vendor',
'wishlist.page','cart.page','billing.page','product-show.page','settings.page',
'profile.page','addresses.page','payment-options.page','orders.page','returns.page',
'wishlists.page','privacy.page','notifications.page','cancellations.page','help-center.page',
'vendor-admin.overview.page','vendor-admin.staffs.page','vendor-admin.products.page','vendor-admin.orders.page','vendor-admin.refunds.page',
'vendor-admin.analytics.page','vendor-admin.reviews.page','vendor-admin.settings.page','vendor-admin.products.store','storage.local',);
        registerArgumentsSet('views', 
'app','mails.vendor-otp','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'PHPMYADMIN_URL','PRIVATE_IP','UID','GID','APP_LOCALE',
...
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','RESEND_API_KEY','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY',
