...
export type VendorApplicationForm = {
  ...
  // Store branding
  store_name: string;
  // slug: string; // Will be generated by backend
...
export const VendorApplyForm: React.FC<{ user?: User | null }> = ({ user }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (user) {
      setData("email", user.email as any);
      setData("name", user.name as any);
    }
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            {/* We will generate slug in backend */}
            {/* NOTE: slug removed from form; will be generated server-side */}
          </div>
