...
export const CreateProductDialog: React.FC<CreateProductDialogProps> = ({
  ...
  const { data, setData, post, processing, errors, reset, clearErrors, handleChange, handleFile, handleFiles } =
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h[85vh] max-w-[70vw] min-w-[70vw] overflow-y-auto p-0">
        ...
        <form className="h-[80vh] overflow-y-hidden" onSubmit={handleSubmit}>
          <ScrollArea className="h-full p-6 pt-0" width={2}>
                            ...
                            <CommandGroup>
                              {brands.map((brand: any) => (
                                ...
                                >
                                  {brand.name}
                                  <Check
                                    className={cn("ml-auto", brandInput === brand.name ? "opacity-100" : "opacity-0")}
                                  />
                                </CommandItem>
                              ))}
                            </CommandGroup>
