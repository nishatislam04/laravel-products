...
import MenuSectionComponent from "@/components/layouts/menu-section";
import { MenuSection } from "@/components/layouts/menu-section";
...
// Menu configuration extracted for reusability
const getMenuSections = (url: string): MenuSection[] => [
  {
...
export default function AccountLayout({ children }: AccountLayoutProps) {
  ...
  const menuSections = getMenuSections(url);
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
            ...
            <div className="lg:col-span-1">
              <div className="space-y-6">
                <MenuSectionComponent sections={menuSections} />
